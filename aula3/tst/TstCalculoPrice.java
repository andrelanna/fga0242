...
public class TstCalculoPrice {
	...
	public void testPreco() throws Exception {
		...
		float prestacoesGeradas = modalidade.calcularPrestacoes();
		float jurosGerados = modalidade.calcularTotalJuros();
		assertEquals(parcelaEsperada, prestacoesGeradas, 2);
		assertEquals(totalJurosEsperado, jurosGerados, 2);
	}
