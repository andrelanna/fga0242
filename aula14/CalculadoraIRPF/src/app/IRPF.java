...
public class IRPF {
	...
	public static final int ALIQUOTA_1A_FAIXA = 0;
	public static final float ALIQUOTA_2A_FAIXA = 0.075f;
	public static final float PISO_2A_FAIXA = 2259.20f;
	public static final float ALIQUOTA_3A_FAIXA = 0.15f;
	public static final float PISO_3A_FAIXA = 2826.65f;
	public static final float ALIQUOTA_4A_FAIXA = 0.225f;
	public static final float PISO_4A_FAIXA = 3751.05f;
	public static final float ALIQUOTA_5A_FAIXA = 0.275f;
	public static final float PISO_5A_FAIXA = 4664.68f;
	...
	float base1aFaixa;
	float imposto1aFaixa;
	float base2aFaixa;
	float imposto2aFaixa;
	float base3aFaixa;
	float imposto3aFaixa;
	float base4aFaixa;
	float imposto4aFaixa;
	float base5aFaixa;
	float imposto5aFaixa;
	...
	public float calcularBaseIRPF() {
		float base = 0;
		//calcula o total de rendimentos
		for (int i=0; i < numRendimentos; i++) {
			if (rendimentoTributavel[i]) {
				base += valorRendimento[i];
			}
		}
		
		//deduz o valor relativo ao numero de dependentes
		base -= numDependentes * 189.59f;
		
		//deduz o valor total de contribuições previdenciarias
		base -= totalContribuicaoPrevidenciaria;
		
		//deduz o valor total de pensao alimenticia
		base -= totalPensaoAlimenticia;
		
		//deduz o valor total de todas as outras deduções
		for (float f: valoresDeducoes) {
			base -= f; 
		}
	...
	public float calcularImposto() {
		return new CalculadoraImpostos(this).computar(); 
	}

	public float getBase1aFaixa() {
		return base1aFaixa;
	}

	public float getImposto1aFaixa() {
		return imposto1aFaixa;
	}

	public float getBase2aFaixa() {
		return base2aFaixa;
	}

	public float getImposto2aFaixa() {
		return imposto2aFaixa;
	}

	public float getBase3aFaixa() {
		return base3aFaixa;
	}

	public float getImposto3aFaixa() {
		return imposto3aFaixa;
	}

	public float getBase4aFaixa() {
		return base4aFaixa;
	}

	public float getImposto4aFaixa() {
		return imposto4aFaixa;
	}

	public float getBase5aFaixa() {
		return base5aFaixa;
	}

	public float getImposto5aFaixa() {
		return imposto5aFaixa;
	}
